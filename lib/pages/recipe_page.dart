...
class RecipePage extends ConsumerWidget {
  ...
  RecipePage({super.key, required this.recipeId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.read(recipeProvider.notifier).fetchRecipe(recipeId);
              ...
              openAddEditRecipe(
                ...
                onSubmit: (submittedRecipe) {
                  Provider((ref) {
                    ...
                    provider.updateRecipe(updatedRecipe: submittedRecipe, id: recipeId);
                  });
                }
              );
            }, 
            label: const Text('Edit Recipe'),
            icon: const PhosphorIcon(PhosphorIconsRegular.pen),
          ),
        ),
      ],
    );
